...
#Monthly
  ...
  m_ts=na.cor(m_ts, orig=d_ts, type="month", limit=3) #function that reintroduces NAs, see functions.R
  #df
...
# Time Series by months i.e. Jan 1982, 1983, 1984,... Feb 1982, ... 
  ## output is a list with one entry per station, each of these contains one list per month (so 12) of with mean daily rainfall in that month
...
# Means and Sums for seasons
	# Aggregate daily to whole season sum/mean by year
  # i.e. mean of rainseason 1982, 1983, .. etc.
  # Nov and Dec values are moved forward, in order that Nov and Dec of 1991 be used together with Jan/92 instead of with Jan/91 
...
## cumulative sum of average rain on each day
